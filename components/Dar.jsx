...
import './css/city.css';
import dar from './dar-es-salaam.jpg'
import axios from 'axios';
import { 
  motion as m, 
} from "framer-motion";

const url = `https://api.openweathermap.org/data/2.5/weather?q=dar-es-salaam&units=imperial&appid=db8b232b0417c091537aee16cac31b4d`
function Dar() {
  ...
  return (
    ...
    >
      <p className='city'>City in Tanzania</p>
      
      <div className='images'>
        <img src={dar} alt="dar es salaam" />
      </div>
